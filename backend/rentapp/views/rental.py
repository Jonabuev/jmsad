...
from rentapp.models import Rental, House, Favorite
from rentapp.serializers import RentalSerializer, MyRentalSerializer, RentalRequestSerializer, HouseSerializer, FavoriteSerializer

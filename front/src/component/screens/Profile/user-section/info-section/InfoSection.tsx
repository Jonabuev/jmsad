  ...
  <div className="p-6">
    <div className="bg-gradient-to-r from-slate-50 to-gray-50 rounded-xl p-6 border border-gray-200">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h2 className="text-xl font-bold text-gray-800">{t("profile.generalInfo")}</h2>
          <p className="text-sm text-gray-600">{t("profile.basicProfileInfo")}</p>
        </div>
      </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{profileData.user.username}</p>
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center justify-between p-3 bg-white rounded-lg border border-gray-100">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{profileData.user.email}</p>
                </div>
              </div>
            </div>
